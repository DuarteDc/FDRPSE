...
class CreateGuideRequest extends Request
{
    public static function rules(): array
    {
        return [
            ...
            'despicable' => "numeric|min:" . (static::post('gradable') === 'gradable' ? "1" : "0"),
            'low'        => "numeric|min:" . (static::post('gradable') === 'gradable' ? (int) static::post('despicable') + 1 : "0"),
            'middle'     => "numeric|min:" . (static::post('gradable') === 'gradable' ? (int) static::post('low') + 1 : "0"),
            'high'       => "numeric|min:" . (static::post('gradable') === 'gradable' ? (int) static::post('middle') + 1 : "0"),
            'very_high'  => "numeric|min:" . (static::post('gradable') === 'gradable' ? (int) static::post('high') + 1 : "0"),
        ];
    }
